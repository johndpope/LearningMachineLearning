...
class ML {
    ...
    class func splitData<T>(_ data: [T], prob: Double) -> (train: [T], test: [T]) {
        var results = [[T](), [T]()]
        for row in data {
    ...
    class func trainTestSplit<T, U>(_ x: [T], y: [U], testPercent: Double) -> (xTrain: [T], xTest: [T], yTrain: [U], yTest: [U]) {
    ...
    class func accuracy(truePositives: Int, falsePositives: Int, trueNegatives: Int, falseNegatives: Int) -> Double {
    ...
    class func precision(truePositives: Int, falsePositives: Int, trueNegatives: Int, falseNegatives: Int) -> Double {
    ...
    class func recall(truePositives: Int, falsePositives: Int, trueNegatives: Int, falseNegatives: Int) -> Double {
        return Double(truePositives) / Double(truePositives + falseNegatives)
    }
    
    // f1 score is the harmonic mean of precision and recall
    class func f1Score(truePositives: Int, falsePositives: Int, trueNegatives: Int, falseNegatives: Int) -> Double {
